...
MODEL_PATH = "models/resnet50/trained/resnet50_best_model.pth"  # update as needed
OUTPUT_DIR_BASE = "results/resnet50/base_model"
ARCH_NAME = "resnet50"
NUM_CLASSES = 9
BATCH_SIZE = 32
...
# --- Transform (same as training script) ---
