...
MODEL_SAVE_PATH = "models/swin_transformer/augmented/swin_transformer_best_model.pth"
NUM_CLASSES = 9
...
if __name__ == "__main__":
    ...
    print("[✅] Augmented Swin model saved.")
