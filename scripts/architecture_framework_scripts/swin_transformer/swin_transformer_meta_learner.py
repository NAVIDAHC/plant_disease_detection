...
DL_MODEL_PATH = "models/swin_transformer/trained/swin_transformer_best_model.pth"
OUTPUT_META_MODEL_PATH = "models/swin_transformer/meta_learner/swin_transformer_meta_learner.pkl"
NUM_CLASSES = 9
